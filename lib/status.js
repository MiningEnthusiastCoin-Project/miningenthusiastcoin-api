...
StatusController.prototype.getInfo = function(callback) {
  this.node.services.miningenthusiastcoind.getInfo(function(err, result) {
    if (err) {
      return callback(err);
    }
    var info = {
...
StatusController.prototype.getMiningInfo = function(callback) {
    return this.node.services.miningenthusiastcoind.getMiningInfo(function(err, result) {
...
StatusController.prototype.getStakingInfo = function(callback) {
    return this.node.services.miningenthusiastcoind.getStakingInfo(function(err, result) {
...
StatusController.prototype.getDgpInfo = function(req, res) {
  ...
  return this.node.services.miningenthusiastcoind.getDgpInfo(function(err, result) {
...
StatusController.prototype.getLastBlockHash = function() {
  var hash = this.node.services.miningenthusiastcoind.tiphash;
  return {
    syncTipHash: hash,
    lastblockhash: hash
  };
...
StatusController.prototype.getBestBlockHash = function(callback) {
  this.node.services.miningenthusiastcoind.getBestBlockHash(function(err, hash) {
    if (err) {
      return callback(err);
    }
    callback(null, {
...
StatusController.prototype.getDifficulty = function(callback) {
  this.node.services.miningenthusiastcoind.getInfo(function(err, info) {
    if (err) {
      return callback(err);
    }
    callback(null, {
...
StatusController.prototype.sync = function(req, res) {
  ...
  this.node.services.miningenthusiastcoind.isSynced(function(err, synced) {
    if (err) {
      return self.common.handleErrors(err, res);
    }
    if (synced) {
    ...
    self.node.services.miningenthusiastcoind.syncPercentage(function(err, percentage) {
      if (err) {
        return self.common.handleErrors(err, res);
      }
      var info = {
        status: status,
        blockChainHeight: self.node.services.miningenthusiastcoind.height,
        syncPercentage: Math.round(percentage),
        height: self.node.services.miningenthusiastcoind.height,
        error: null,
        type: 'miningenthusiastcoincore node'
      };
